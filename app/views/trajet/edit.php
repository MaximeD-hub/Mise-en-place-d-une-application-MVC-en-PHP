    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0">Modifier un trajet</h3>
            </div>
            <div class="card-body">
                <form method="POST" action="/trajet/update/<?= $trajet['id_trajet'] ?>">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" value="<?= htmlspecialchars($trajet['employe_nom']) ?>" readonly>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Prénom</label>
                            <input type="text" class="form-control" value="<?= htmlspecialchars($trajet['employe_prenom']) ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input 
                                ...
                                id="gdh_depart" 
                                name="gdh_depart" 
                                value="<?= date('Y-m-d\TH:i', strtotime($trajet['gdh_depart'])) ?>"
                                required
                            >
                        ...
                        <div class="col-md-6">
                            ...
                            <input 
                                ...
                                id="gdh_arrivee" 
                                name="gdh_arrivee" 
                                value="<?= date('Y-m-d\TH:i', strtotime($trajet['gdh_arrivee'])) ?>"
                                required
                            >
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input 
                                type="number" 
                                class="form-control <?= isset($_SESSION['errors']['nb_places_dispo']) ? 'is-invalid' : '' ?>" 
                                id="nb_places_dispo" 
                                name="nb_places_dispo" 
                                min="0" 
                                max="8" 
                                value="<?= $trajet['nb_places_dispo'] ?>"
                                required
                            >
                            <?php if (isset($_SESSION['errors']['nb_places_dispo'])): ?>
                                <div class="invalid-feedback">
                                    <?= htmlspecialchars($_SESSION['errors']['nb_places_dispo']) ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
